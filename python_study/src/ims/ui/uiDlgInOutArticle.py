...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lineEdit_articlename.setEnabled(False)
        ...
        self.comboBox_price = QtGui.QComboBox(self.groupBox)
        self.comboBox_price.setObjectName(_fromUtf8("comboBox_price"))
        self.horizontalLayout_2.addWidget(self.comboBox_price)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_unit.setText(_translate("Dialog", "TextLabel", None))
        self.label_price.setText(_translate("Dialog", "    单价(元):", None))
